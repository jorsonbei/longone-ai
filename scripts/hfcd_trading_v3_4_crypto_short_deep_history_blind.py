#!/usr/bin/env python3
"""HFCD Trading V3.4: crypto short deep-history blind.
...
VERSION = "HFCD_Trading_V3_4_CryptoShortDeepHistoryBlind"
ROOT = Path.cwd()
OUT_DIR = ROOT / "outputs" / "hfcd_trading_v3_4_crypto_short_deep_history_blind"
...
def main() -> None:
    ...
    write_csv(OUT_DIR / "hfcd_trading_v3_4_data_coverage.csv", coverage)
    ...
    png_path = OUT_DIR / "HFCD_Trading_V3_4_CryptoShortDeepHistoryBlind.png"
    ...
    write_csv(OUT_DIR / "hfcd_trading_v3_4_policy_summary.csv", summaries)
    write_csv(OUT_DIR / "hfcd_trading_v3_4_selected_routes.csv", selected)
    write_csv(OUT_DIR / "hfcd_trading_v3_4_selected_trades.csv", selected_trades)
    (OUT_DIR / "hfcd_trading_v3_4_summary.json").write_text(json.dumps(summary, ensure_ascii=False, indent=2), encoding="utf-8")
    (OUT_DIR / "HFCD_Trading_V3_4_CryptoShortDeepHistoryBlind.md").write_text(render_report(summary), encoding="utf-8")
