#!/usr/bin/env python3
"""HFCD Trading V3.2: short-side blind repair.
...
VERSION = "HFCD_Trading_V3_2_ShortSideBlindRepair"
ROOT = Path.cwd()
OUT_DIR = ROOT / "outputs" / "hfcd_trading_v3_2_short_side_blind_repair"
...
def main() -> None:
    ...
    png_path = OUT_DIR / "HFCD_Trading_V3_2_ShortSideBlindRepair.png"
    ...
    (OUT_DIR / "HFCD_Trading_V3_2_ShortSideBlindRepair.md").write_text(render_report(summary), encoding="utf-8")
