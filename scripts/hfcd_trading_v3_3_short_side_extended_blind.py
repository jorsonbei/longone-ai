#!/usr/bin/env python3
"""HFCD Trading V3.3: short-side extended blind.
...
VERSION = "HFCD_Trading_V3_3_ShortSideExtendedBlind"
ROOT = Path.cwd()
OUT_DIR = ROOT / "outputs" / "hfcd_trading_v3_3_short_side_extended_blind"
...
def main() -> None:
    ...
    write_csv(OUT_DIR / "hfcd_trading_v3_3_data_coverage.csv", coverage)
    ...
    png_path = OUT_DIR / "HFCD_Trading_V3_3_ShortSideExtendedBlind.png"
    ...
    write_csv(OUT_DIR / "hfcd_trading_v3_3_policy_summary.csv", summaries)
    write_csv(OUT_DIR / "hfcd_trading_v3_3_selected_routes.csv", selected)
    write_csv(OUT_DIR / "hfcd_trading_v3_3_selected_trades.csv", selected_trades)
    (OUT_DIR / "hfcd_trading_v3_3_summary.json").write_text(json.dumps(summary, ensure_ascii=False, indent=2), encoding="utf-8")
    (OUT_DIR / "HFCD_Trading_V3_3_ShortSideExtendedBlind.md").write_text(render_report(summary), encoding="utf-8")
