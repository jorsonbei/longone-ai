...
const hfcdSectionCopy: Record<Locale, {
  ...
  zh: {
    eyebrow: '研发数据诊断',
    title: '把你的实验数据，变成最优先的研发升级方案',
    body: '上传实验数据、芯片参数、材料配方、新能源寿命数据、生命科学批次数据，系统自动找出最致命的高风险样本、主要失效原因和优先修复动作。少走十年弯路，让研发速度直接起飞。',
    primary: '立即开始数据诊断',
    secondary: '查看行业价值',
    gates: [
      '找出谁最危险：把高风险样本优先排出来。',
      '解释为什么危险：定位核心退化、支撑不足、负荷过载或风险外扩。',
      '验证是否真有用：用历史真实失效标签计算 AUC、Top10 命中率和 baseline 对比。',
      '给出下一步动作：把诊断结果转成研发修复建议和升级路线。',
    ],
  },
  fr: {
