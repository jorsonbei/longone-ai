...
const uiTextByLocaleBase: Record<Exclude<Locale, 'ja'>, UiText> = {
  en: {
    ...
    input: {
      ...
      disclaimer: 'Thing-Nature may be imperfect. Verify important facts.',
  ...
  zh: {
    ...
    sidebar: {
      ...
      officialSiteSubtitle: '理解理论、产业与社会价值',
      adminTitle: '管理后台',
    ...
    officialSite: {
      ...
      evidenceEyebrow: 'Evidence',
      industriesEyebrow: 'Industries',
      industriesTitle: '物性论对关键行业的价值',
      industriesDescription: '每个行业都在面对自己的技术难题，但它们其实共享同一个更深的问题：怎样把高能量、高复杂度的系统，组织成长期稳定、可扩展、可治理的结构。',
      overviewLabel: '总论',
      overviewTitle: '科技文明真正的竞争，最后都不是“谁更热”，而是“谁能把更大的能量、更高的复杂度和更强的不确定性，压进更稳定的结构”。',
      overviewBody: '芯片、AI、机器人、能源、生命科学表面上属于不同产业，底层上却共享同一场战争：能量会不会溢出，结构会不会塌陷，系统能不能把局部能力沉淀成长期秩序。',
      industryProblem: '行业问题',
      shortJudgment: '短版判断',
      longArgument: '长版论证',
      iterationEyebrow: 'Iteration',
      featuredExperiment: '重点实验',
      nextStep: '下一步',
      bookEyebrow: 'Book',
      faqEyebrow: 'FAQ',
      faqTitle: '常见问题',
      coreThesis: '真正的进步，不是能量变大，而是能量被组织成了稳定结构。',
      industryValue: '产业价值',
      industryValueBody: '帮助判断什么是底层能力，什么只是高热度、低结构的扩张。',
      socialValue: '社会价值',
      socialValueBody: '帮助普通人理解秩序为什么形成，系统为什么失控，以及技术如何真正服务现实世界。',
      amazonSample: '阅读 Amazon 试读',
    },
  },
  fr: {
    brand: {
    ...
    input: {
      ...
      disclaimer: 'Thing-Nature peut se tromper. Verifiez les informations importantes.',
  ...
  es: {
    ...
    input: {
      ...
      disclaimer: 'Thing-Nature puede equivocarse. Verifica la informacion importante.',
      localAttachment: 'Local',
  ...
  vi: {
    ...
    input: {
      ...
      disclaimer: 'Thing-Nature co the sai. Hay kiem tra thong tin quan trong.',
  ...
  de: {
    ...
    input: {
      ...
      disclaimer: 'Thing-Nature kann ungenau sein. Bitte wichtige Fakten pruefen.',
...
const ja: UiText = {
  ...
  input: {
    ...
    disclaimer: 'Thing-Natureは誤ることがあります。重要な情報は必ず確認してください。',
